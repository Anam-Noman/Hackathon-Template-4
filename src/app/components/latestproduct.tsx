...
export default function LatestProducts
 () {
  const products = [
    { id: 1, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", image: "image 1166.png" },
    { id: 2, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", image: "image 15.png", sale: true },
    { id: 3, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", image: "image 1168.png" },
    { id: 4, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", image: "image 23.png" },
    { id: 5, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", image: "image 311.png" },
    { id: 6, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", image: "image 3.png" },
  ];
